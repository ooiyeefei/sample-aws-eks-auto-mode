...
echo ""
echo -e "${BLUE}🏗️  Build and Push Commands:${NC}"
...
echo "  2. Build your custom image using the build commands"
echo "  3. Update your Kubernetes deployments to use the new private registry URL"
echo ""
